 ...
 */
package com.fliggy.http_module.http.utils;

import com.fliggy.http_module.http.model.LzyResponse;
import com.fliggy.http_module.http.model.SimpleResponse;
        ...
        if (rawType != LzyResponse.class) {
            ...
            if (typeArgument == Void.class) {
                ...
                if (code == 200) {
                    ...
                    throw new IllegalStateException("token不存在");
                } else if (code == 102) {
                    throw new IllegalStateException("token已经失效,请重新登录");
                } else if (code == 202) {
                    throw new IllegalStateException("签名错误");
                } else if (code == 303) {
                    throw new IllegalStateException("账号已封");
                } else if (code == 400) {
                    return (T) lzyResponse;
                } else {
