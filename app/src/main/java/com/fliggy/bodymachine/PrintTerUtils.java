...
public class PrintTerUtils {
    ...
    private PrintTerUtils(Activity mainActivity){
        this.mainActivity = mainActivity;
        connectDevices(mainActivity);
    }

    public static PrintTerUtils getPrintTerUtils(Activity mainActivity){
     ...
     * 连接设备
    */
    private void connectDevices(Activity mainActivity){
        this.mainActivity = mainActivity;
        if(printer==null){
